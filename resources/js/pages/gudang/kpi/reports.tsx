...
export default function GudangKpiReports({ reports, canCreate }: Props) {
      ...
      <div className="space-y-6">
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            {canCreate && (
              <Link href="/gudang/kpi/report/create">
                <Button>
              ...
              <div className="space-y-3">
                {reports.data.map((report) => (
                  <div key={report.id} className="flex flex-col md:flex-row items-start md:items-center gap-3 py-4 border-b last:border-0">
                    ...
                    {canCreate && (
                      <Link href={`/gudang/kpi/report/${report.id}/edit`}>
        ...
        {reports.last_page > 1 && (
          <div className="flex justify-center gap-2">
            {Array.from({ length: reports.last_page }, (_, i) => i + 1).map((page) => (
              <Link key={page} href={`/gudang/kpi/reports?page=${page}`}>
