...
export default function PengawasSvpIndex() {
    setLayoutProps({
        breadcrumbs: [{ title: 'Pengawas SVP Area', href: '/pengawas-svp' }],
    });

    return (
        <>
            <Head title="Pengawas SVP Area" />
                ...
                <div className="flex flex-col items-center justify-center gap-6 rounded-lg border border-dashed bg-card p-12 text-center">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Area pengawasan khusus untuk posisi SVP. Konten
