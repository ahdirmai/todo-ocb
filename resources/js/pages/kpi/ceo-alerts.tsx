...
import { ArrowLeft, AlertCircle, Clock, FileX } from 'lucide-react';
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              {new Date(date).toLocaleDateString('id-ID', { dateStyle: 'long' })} - {totalAlerts} total alerts
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card className="border-red-200 bg-red-50">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-red-800">Grade D - Kritis</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-orange-200 bg-orange-50">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-orange-800">Laporan Terlambat</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-yellow-200 bg-yellow-50">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-yellow-800">Laporan Belum Masuk</CardTitle>
            </CardHeader>
            <CardContent>
            ...
            <CardContent>
              <div className="space-y-2">
                {gradeDAlerts.map((score) => (
                  <div key={score.id} className="flex items-center justify-between p-4 bg-red-50 border border-red-200 rounded-lg">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        ...
                        <p className="font-semibold">{score.verified_tasks}/{score.total_tasks}</p>
                      </div>
                      <div className="text-right">
                        <p className="text-sm text-muted-foreground">Skor</p>
                        <p className="text-2xl font-bold text-red-600">{score.total_score.toFixed(2)}%</p>
                      </div>
        ...
        {totalAlerts === 0 && (
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <p className="text-muted-foreground">Semua manager perform dengan baik hari ini</p>
            </CardContent>
          </Card>
        )}
      </div>
